---
title: '`Quiz 1` Reproducible Research'
...
* `r if(!knitr::is_html_output()) {"&#x1F30E; Rpubs: [Interactive Document](https://rpubs.com/AndersonUyekita/quiz-1_reproducible-research)"}else{"&#x1F4E6; Github Repository: [Static Document](https://github.com/AndersonUyekita/reproducible-research/blob/main/Week%201/quiz-1_reproducible-research.md){target='_blank' rel='noopener'}"}`
